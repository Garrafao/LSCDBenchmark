...
class TestCache(unittest.TestCase):
            ...
            overrides=overrides(
                {
                    ...
                    "task.model.wic.prediction_cache.is_active": "false", # is deactivated for contextual_embedder by default
        ...
        config = compose(config_name="config", return_hydra_config=True, overrides=overrides(
                    {
                        ...
                        "task.model.prediction_cache.is_active": "false", # is deactivated for contextual_embedder by default
                        "dataset": "testwug_en_111",
    ...
    def test_bert_pred_apd_change_graded_eng_simple_arm(self) -> None:
    ...
    def test_bert_pred_apd_change_graded_ger(self) -> None:
    ...
    def test_bert_pred_wic_eng_simple_arm(self) -> None:
    ...
    def test_bert_pred_wic_eng_simple_plane_afternoon(self) -> None:
    ...
    def test_bert_pred_wic_eng_simple_plane_afternoon_lemma(self) -> None:
    ...
    def test_bert_pred_wic_eng_simple_plane_afternoon_similarity(self) -> None:
    ...
    def test_bert_pred_wic_eng_simple_plane_afternoon_model(self) -> None:
    ...
    def test_dm_pred_apd_change_graded_eng_simple_arm(self) -> None:
    ...
    def test_dm_pred_wic_eng_simple_arm(self) -> None:
    ...
    def test_dm_pred_wic_eng_simple_plane_afternoon(self) -> None:
    ...
    def test_dm_pred_wic_eng_simple_plane_afternoon_lemma(self) -> None:
    ...
    def test_dm_pred_wic_eng_simple_plane_afternoon_model(self) -> None:
